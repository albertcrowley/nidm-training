...
One concept that will make writing SPARQL queries a bit easier is understanding that the RDF file is structured as a set of "triples." A tripple consists of a subject-predicate-object. For example the tripple "X, was generated by, Y" or "subject X, has the age of, 7". 
